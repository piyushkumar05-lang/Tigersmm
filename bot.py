...
def package_menu(service):
    menus = {
        "👥 𝗙𝗢𝗟𝗢𝗪𝗘𝗥𝗦 🔥": [
            ...
            ["🚀 𝟱𝟬𝟬 𝗙𝗼𝗹𝗼𝘄𝗲𝗿𝘀 • ₹𝟮𝟵 💸", "👑 𝟭𝗞 𝗙𝗼𝗹𝗼𝘄𝗲𝗿𝘀 • ₹𝟱𝟱 💸"]
        ],
        "❤️ 𝗟𝗜𝗞𝗘𝗦 💎": [
...
async def button_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "check_join":
        if await check_joined(user_id, context):
            ...
            await query.answer("❌ Pehle @trust_zonw join karo!", show_alert=True)
...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if text in ["👥 𝗙𝗢𝗟𝗢𝗪𝗘𝗥𝗦 🔥", "❤️ 𝗟𝗜𝗞𝗘𝗦 💎", "💬 𝗖𝗢𝗠𝗘𝗡𝗧𝗦 ⚡", "🎬 𝗩𝗜𝗘𝗪𝗦 🚀"]:
        state["service"] = text
    ...
    if "₹" in text:
        ...
        state["package"] = text
        state["price"] = price
        state["order_id"] = f"#TZ{random.randint(10000,99999)}"
...
if __name__ == "__main__":
    ...
    print("💀 TRUST ZONE BOT RUNNING...")
    app.run_polling()            ["🔥 𝟭𝟬𝟬 𝗙𝗼𝗹𝗹𝗼𝘄𝗲𝗿𝘀 • ₹𝟲 💸", "⚡ 𝟯𝟬𝟬 𝗙𝗼𝗹𝗹𝗼𝘄𝗲𝗿𝘀 • ₹𝟭𝟳 💸"],
            ["🚀 𝟱𝟬𝟬 𝗙𝗼𝗹𝗼𝘄𝗲𝗿𝘀 • ₹𝟮𝟵 💸", "👑 𝟭𝗞 𝗙𝗼𝗹𝗹𝗼𝘄𝗲𝗿𝘀 • ₹𝟱𝟱 💸"]
        ],
        "❤️ 𝗟𝗜𝗞𝗘𝗦 💎": [
            ["🔥 𝟱𝟬 𝗟𝗶𝗸𝗲𝘀 • ₹𝟰 💸", "⚡ 𝟭𝟬𝟬 𝗟𝗶𝗸𝗲𝘀 • ₹𝟳 💸"],
            ["💎 𝟮𝟬𝟬 𝗟𝗶𝗸𝗲𝘀 • ₹𝟭𝟰 💸", "🚀 𝟱𝟬𝟬 𝗟𝗶𝗸𝗲𝘀 • ₹𝟯𝟮 💸"]
...
async def handle(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("❌ 𝗜𝗡𝗩𝗔𝗟𝗜𝗗 𝗢𝗣𝗧𝗜𝗢𝗡\n👇 𝗨𝘀𝗲 𝗺𝗲𝗻𝘂 𝗯𝘂𝘁𝘁𝗼𝗻𝘀", reply_markup=main_menu())
